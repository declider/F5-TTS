...
def parse_args():
	...
	parser.add_argument("--logger", type=str, default="tensorboard", choices=["wandb", "tensorboard"], help="logger")
	parser.add_argument(
		"--bnb_optimizer",
		type=bool,
		default=False,
	...
	parser.add_argument("--ckpt_path", type=str, default=None, help="Checkpoint's folder path")
...
def main():
	...
	train_dataset = load_dataset(args.dataset_name, tokenizer=tokenizer, mel_spec_kwargs=mel_spec_kwargs, dataset_path=args.dataset_path)
